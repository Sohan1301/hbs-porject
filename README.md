...
# Installation:
It's very easy process. Clone the repository and run the backend file in springboot by adding your database password and run it. Then open frontend file in visual stuido use the below commandsin terminal 
1. npm install
2. npm start

output will appear in browser.

Make sure you run both backend and frontend files parllely so the the axios links work perfectly to check the output.
